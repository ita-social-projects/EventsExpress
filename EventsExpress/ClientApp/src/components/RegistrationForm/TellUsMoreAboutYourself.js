            ...
            <Grid container spacing={2} className="text-left">
                <Grid item xs={4}>
                    ...
                    <label className="font-weight-bold">Select parent status</label>
                        <Field name="parentstatus" component={radioButton} parse={String} >
                        <FormControlLabel value={parentStatusEnum.Kids} control={<Radio />} label={parentStatusEnum.Kids} />
                        <FormControlLabel value={parentStatusEnum.NoKids} control={<Radio />} label={parentStatusEnum.NoKids} />
                    </Field>
                    </div>
                    <div class="stepper-tellusmore-block">
                ...
                <Grid item xs={4}>
                    <div class="stepper-tellusmore-block">
                        ...
                        <Field name="relationshipstatus" component={radioButton} parse={String} >
                            <FormControlLabel value={relationShipStatusEnum.Single} control={<Radio />} label={relationShipStatusEnum.Single} />
                            <FormControlLabel value={relationShipStatusEnum.InARelationship} control={<Radio />} label={relationShipStatusEnum.InARelationship} />
                        </Field>
                    </div>
                    <div class="stepper-tellusmore-block">
                        <label className="font-weight-bold">Select the type of leisure status</label>
                        <Field name="thetypeofleisure" component={radioButton} parse={String} >
                            <FormControlLabel value={theTypeOfLeisureEnum.Active} control={<Radio />} label={theTypeOfLeisureEnum.Active} />
                            <FormControlLabel value={theTypeOfLeisureEnum.Passive} control={<Radio />} label={theTypeOfLeisureEnum.Passive} />
                        </Field>
                    </div>
                </Grid>
                <Grid item xs={4}></Grid>
