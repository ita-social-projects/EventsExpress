    ...
    public static class DbInitializer
    {
        public static void Seed(AppDbContext dbContext, IPasswordHasher passwordHasher)
        {
            ...
            var emailMessages = new[]
            {
                ...
                new NotificationTemplate { Id = NotificationProfile.EventStatusCanceled, Title = "EventStatusCanceled", Subject = "The event you have been joined was canceled",  Message = "Dear {{UserName}}, the event you have been joined was CANCELED. The reason is: {{Reason}} \"<a href='{{EventLink}}'>{{Title}}</a>\"" },
                new NotificationTemplate { Id = NotificationProfile.EventStatusBlocked, Title = "EventStatusBlocked", Subject = "The event you have been joined was blocked",  Message = "Dear {{UserName}}, the event you have been joined was BLOCKED. The reason is: {{Reason}} \"<a href='{{EventLink}}'>{{Title}}</a>\"" },
                new NotificationTemplate { Id = NotificationProfile.EventStatusActivated, Title = "EventStatusActivated", Subject = "The event you have been joined was activated",  Message = "Dear {{UserName}}, the event you have been joined was ACTIVATED. The reason is: {{Reason}} \"<a href='{{EventLink}}'>{{Title}}</a>\"" },
                new NotificationTemplate { Id = NotificationProfile.ParticipationApproved, Title = "ParticipationApproved", Subject = "Approving participation", Message = "Dear {{UserName}}, you have been approved to join to this event. To check it, please, visit \"<a href='{{EventLink}}'>EventExpress</a>\"" },
                new NotificationTemplate { Id = NotificationProfile.ParticipationDenied, Title = "ParticipationDenied", Subject = "Denying participation", Message = "Dear {{UserName}}, you have been denied to join to this event. To check it, please, visit \"<a href='{{EventLink}}'>EventExpress</a>\"" },
