...
namespace EventsExpress.Test.HandlerTests
{
    internal class UnblockedEventHandlerTests
    {
        ...
        private UnblockedEventMessage _unBlockedEventMessage;
        private Guid idUnBlockedEventMessage = Guid.NewGuid();
        ...
        public void Initialize()
        {
            ...
            _unBlockedEventHandler = new UnblockedEventHandler(_emailService.Object, _userService.Object, _eventService.Object);
            ...
            _unBlockedEventMessage = new UnblockedEventMessage(usersId, idUnBlockedEventMessage);
            _eventDto = new EventDto
            {
                Id = idUnBlockedEventMessage,
                Title = eventTitle,
            };
        ...
        {
            var result = _unBlockedEventHandler.Handle(_unBlockedEventMessage, CancellationToken.None);
