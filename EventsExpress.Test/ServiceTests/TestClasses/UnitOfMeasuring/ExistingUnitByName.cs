...
namespace EventsExpress.Test.ServiceTests.TestClasses.UnitOfMeasuring
{
    public class ExistingUnitByName : IEnumerable
    {
        ...
        public IEnumerator GetEnumerator()
        {
            ...
            yield return new object[] { randomStringName, correctShortName, Is.True };
            yield return new object[] { correctUnitName, randomStringName,  Is.True };
            yield return new object[] { deletedUnitName, deletedShortName, Is.True };
        }
    }
}
